        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              A MiniCom é uma loja de gadgets, produtos de tecnologia, entre
              outros, que oferece alta qualidade com garantia e suporte completo.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-center md:text-left">
              © 2025 <a href="https://manassesndombele.com">Manassés Ndombele</a>. Todos os direitos reservados.
            </p>
          ...
          <div className="mt-8 p-4 bg-orange-900 bg-opacity-50 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-orange-100">
                <strong>Aviso Importante:</strong> Se o cliente cometer algum
                erro na solicitação do produto (endereço incorreto, telefone
                inválido, etc.) que dificulte a entrega, o mesmo deverá efetuar
                o pagamento da taxa de reenvio para uma nova tentativa de
                entrega.
              </div>
            </div>
          </div>
